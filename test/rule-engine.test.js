...
const tests = [
  ...
  },
  {
    ...
    run() {
      ...
      assert.equal(anti.productSmiles, "CCC(Br)");
    },
  },
  {
    ...
    run() {
      ...
      assert.equal(candidate.productSmiles, "CCC(Br)(C)C");
    },
  },
  {
    ...
    run() {
      ...
      assert.equal(candidates[1].productSmiles, "CC(C)C(Br)C");
    },
  },
  {
    ...
    run() {
      ...
      assert.equal(candidates[1].productSmiles, "CC(C)(C)C(Br)C");
    },
  },
  {
  ...
  },
  {
    ...
    run() {
      ...
      assert.equal(anti.productSmiles, "CCC(O)");
    },
  },
  {
    ...
    run() {
      ...
      assert.equal(candidate.productSmiles, "CC(Br)C(Br)");
    },
  },
  {
